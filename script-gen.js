...
function addSong() {
    ...
    var parseInt(bpm = document.getElementById("newBpm").value);
    var parseInt(bpm_base = document.getElementById("newBpmBase").value);
    var set = document.getElementById("newSet").value;
    var purchase = document.getElementById("newPurchase").value;
    var parseInt(audioPreview = document.getElementById("newAudioPreview").value);
    var parseInt(audioPreviewEnd = document.getElementById("newAudioPreviewEnd").value);
    var parseInt(side = document.getElementById("newSide").value);
    var bg = document.getElementById("newBg").value;
    var bg_inverse = document.getElementById("newBgInverse").value;
    var parseInt(date = document.getElementById("newDate").value);
